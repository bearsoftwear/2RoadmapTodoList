...
import { Search, MoreVert, ArrowUpward, ArrowDownward, ArrowForward, FilterList, ViewAgenda } from "@mui/icons-material"
            ...
            <TableBody>
              {tasks.map((task) => {
                ...
                return (
                  ...
                  >
                    <TableCell padding="checkbox">
                      <Checkbox checked={isItemSelected} onClick={() => handleSelect(task.id)} />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell align="right">{renderStatusChip(task.status)}</TableCell>
                    <TableCell align="right">{renderPriority(task.priority)}</TableCell>
                    <TableCell align="right">
